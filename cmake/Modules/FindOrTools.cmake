...
find_path(ORTOOLS_INCLUDE_DIR constraint_solver/constraint_solver.h HINTS ${ORTOOLS_DIR}/ortools DOC "or-tools include directory")
find_library(ORTOOLS_LIBRARY ortools HINTS ${ORTOOLS_DIR}/lib DOC "or-tools constraint solver library")
mark_as_advanced(ORTOOLS_LIBRARY ORTOOLS_INCLUDE_DIR)

# standard handling
include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(OrTools DEFAULT_MSG ORTOOLS_LIBRARY ORTOOLS_INCLUDE_DIR)
